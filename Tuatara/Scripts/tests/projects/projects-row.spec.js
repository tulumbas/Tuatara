// tests the row editor controller for projects
...
// 2. calling getProjects returns array of projects
...
describe('projects-row controller', function () {
    ...
    const serviceUrl = '/api/projects', rowController = 'projectsRowController';
    ...
    describe('2. getProjects', function () {
        it('calling getProjects returns array of projects',
            inject(function ($injector, $controller) {
                // initialize controller for record 3
                var ctrl = loadRecordById(3, testData_3, $controller);

                // expect a query searching for projects containing 'a'
