...
describe('workforce-list component', function () {
    const testData = [
        { id: 2, name: 'Stan', parentID: null, parentName: null },
        { id: 3, name: 'Benji', parentID: 1, parentName: 'Will' },
        { id: 1, name: 'Will', parentID: null, parentName: null }
    ];
    ...
    describe('2. Delete workforce record', function () {
